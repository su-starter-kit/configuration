...
This package provides configuration package for usage in the companies projects.
Please add a reference to this pakage to use pre built configuration manager.
